...
class Blockchain(object):
    ...
    def valid_chain(self,chain):
        ...
        while current_index<len(chain):
            ...
            #当前block=chain（这里实际指get /chain 即所有数据
            print(f'{last_block}')
            print(f'{block}')
            print("\n______\n")
            # 检查block的散列是否正确
    ...
    #classsmethod 也不需要self参数，但第一个参数需要表示自身类但cls参数
    def hash(block):
        """
        给一个区块生成 SHA-256 值
        :param block:
